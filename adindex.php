...
<div class="header">
  ...
  <div class="header-right">
    ...
    <a class="active"  href="adindex.php">Home</a>
...
<center>
<a href="aduserbooksch.php" target="_blank"><button class="button4" onclick="userbooksch.php" >Search book</button></a>
<a href="adbookdata.php" target="_blank"><button class="button4" onclick="adbookdata.php" >UPDATE BOOK</button></a>
<a href="adshowbookingbook.php" target="_blank"><button class="button5" onclick="adshowbookingbook.php" >Show Bookings</button></a>
...
<div class="text2"> <button class="button3" onclick="window.location.href='adbranchers.php'"><b>Read More</b></button></div>
 </div>
</div>
</td>
