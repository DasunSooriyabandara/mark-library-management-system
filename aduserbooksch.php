...
<center>
<a href="adallbook.php" target="_blank"><button id="button2" onclick="adallbook.php" >All Books</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="adbookingbook.php" target="_blank"><button id="button2" onclick="bookingbook.php" >Booking a book</button></a>	
     </center>
</div>
